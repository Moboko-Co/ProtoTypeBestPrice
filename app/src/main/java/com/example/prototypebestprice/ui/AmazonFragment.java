...
public class AmazonFragment extends Fragment {
    ...
    private AmazonViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.amazon_fragment, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mViewModel = ViewModelProviders.of(this).get(AmazonViewModel.class);

        mChart = getActivity().findViewById(R.id.amazon_chart);
        // Grid背景色
